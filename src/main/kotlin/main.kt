fun main() {
    ...
    val photoAttachment = PhotoAttachment (Photo("Фотка"))
    ...
    val firstPost = Post(id = 2, ownerId=0, fromId = 0, createdBy = 0, date = 0, attachment = attachments,  text = "aaa", replyOwnerId = 0, replyPostId = 0,
    ...
    val secondPost = Post(id = 2, ownerId=0, fromId = 0, createdBy = 0, date = 0, text = "aaa", replyOwnerId = 0, replyPostId = 0,
        friendsOnly = true, comments = comments1, copyright = copyright1, likes = likes1, repost = reposts1, views = views1,
        postType = "", signerId = 0, canPin = true, canDelete = true, canEdit = true, isPinned = true, markedAsAds = true,
        isFavorite = true, donut = donut1, postponedId = 0)
